        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrganizationPermissions_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrganizationPermissions_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserOrganization", x => new { x.OrganizationsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_AppUserOrganization_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrganizationRoles_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganizationRoles_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "AppUserOrganizationRole",
                columns: table => new
                {
                    OrganizationRolesId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserOrganizationRole", x => new { x.OrganizationRolesId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_AppUserOrganizationRole_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserOrganizationRole_OrganizationRoles_OrganizationRolesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrganizationRolePermissions_OrganizationPermissions_PermissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WinnerOrganizationId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auction_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Auction_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Auction_AspNetUsers_WinnerUserId",
                        column: x => x.WinnerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Auction_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Auction_Organizations_WinnerOrganizationId",
                        column: x => x.WinnerOrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bid_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bid_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bid_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bid_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserOrganization_UsersId",
                table: "AppUserOrganization",
                column: "UsersId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserOrganizationRole_UsersId",
                table: "AppUserOrganizationRole",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auction_CreatedById",
                table: "Auction",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Auction_ModifiedById",
                table: "Auction",
                column: "ModifiedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auction_WinnerOrganizationId",
                table: "Auction",
                column: "WinnerOrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_Auction_WinnerUserId",
                table: "Auction",
                column: "WinnerUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationPermissions_CreatedById",
                table: "OrganizationPermissions",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationPermissions_ModifiedById",
                table: "OrganizationPermissions",
                column: "ModifiedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationRoles_CreatedById",
                table: "OrganizationRoles",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationRoles_ModifiedById",
                table: "OrganizationRoles",
                column: "ModifiedById");
